...
public class MPSE {
	...
	public static void main(String[] args) {
				...
				driver.findElement(By.xpath("/html/body/div/div/div/div[3]/div[1]/div/form/div[1]/div[2]/div[4]/button")).click();
				...
				driver.findElement(By.id("bedCountEffectiveDate")).click();
